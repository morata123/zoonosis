...
<html>
	...
	<body>
		<div class="container">
			...
			<h3 align="center">ADMINISTRADOR USUARIOS</h3>
			<br />
				...
				<div class="modal-header">
		      	...
		      	<div class="modal-body">
			        ...
			        <div class="form-group">
			        	...
			        	<input type="text" name="password" id="password" class="form-contfec_nac" />
			        </div>
					<div class="form-group">
            			<label for="id_rol">id_rol</label>
            			<select id="id_rol" name="id_rol" runat="server" class="form-contid_rol" required="required"></select>          
         			</div>
...
$(document).ready(function(){
	...
	var id_rol= $('#id_rol');
	$.ajax({
			 url: '/rest1/api/test_api_rol.php?action=fetch_all',
			 method: 'post',
			 dataType: 'json',
			 success: function (data) {
				 $(data).each(function (index, item) {
					id_rol.append($('<option/>', { value: item.id_rol, text: item.rol }));
				 });
			 },
			 error: function (err) {
